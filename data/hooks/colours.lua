...
function loc_colour(_c, _default)
    ...
    G.ARGS.LOC_COLOURS.UNIK_SHITTY_EDITION = {0,0,0,1}
    G.ARGS.LOC_COLOURS.UNIK_LARTCEPS1 = {1,0,0,1}
    G.ARGS.LOC_COLOURS.UNIK_RGB = {0,0,0,1}
    G.ARGS.LOC_COLOURS.UNIK_ANCIENT = {0,0,0,1}
    G.ARGS.LOC_COLOURS.UNIK_RGB_HUE = 0
    G.ARGS.LOC_COLOURS.UNIK_LARTCEPS_INVERSE = {1,0,0,1}
    ...
    G.ARGS.LOC_COLOURS.UNIK_SYNC_CATALYST_FAIL = {0,0,0,1}
