SMODS.Tag{
	...
	apply = function(self, tag, context)
        if context.type == self.config.type then
            if context.card and not context.card.ability.unik_disposable and context.card.ability.set == 'Joker' and not SMODS.is_eternal(context.card,self) 
            and context.card.config.center.perishable_compat
