BLINDSIDE.Blind({
    ...
    loc_vars = function(self, info_queue, card)
        ...
        return {
            vars = {
                card.ability.extra.mult, active and localize('k_active_ex') or localize('k_inactive_ex'),card.ability.extra.jokermult , colours = {active and G.C.FILTER or  G.C.UI.TEXT_INACTIVE}
            }
        }
    end,
