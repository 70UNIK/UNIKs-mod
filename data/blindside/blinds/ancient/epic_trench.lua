...
BLINDSIDE.Blind({
    ...
    loc_vars = function(self, info_queue, card)
        return {
            vars = {
                tostring(card.ability.extra.e_chips_gain),card.ability.extra.e_chips_base,card.ability.extra.e_chips,card.ability.extra.x_chips_gain,card.ability.extra.x_chips_base,card.ability.extra.x_chips
            }
        }
    end,
    upgrade = function(card)
        if not card.ability.extra.upgraded then
            ...
            card.ability.extra.x_chips_base = card.ability.extra.x_chips_base + card.ability.extra.x_chips_up
            card.ability.extra.x_chips_gain = card.ability.extra.x_chips_gain + card.ability.extra.x_chips_gain_up
